...
const RealtimeDot = memo(function RealtimeDot() {
  return (
    <span className="stat-realtime-badge" aria-label="อัปเดตอัตโนมัติ">
    ...
    <div className="app">
        ...
        <div className="container header-inner">
          ...
          <div className="header-meta">
            <div className="header-meta-pill">
              <svg viewBox="0 0 24 24" width="11" height="11" fill="none" stroke="currentColor" strokeWidth="2"><path d="M20.84 4.61a5.5 5.5 0 00-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 00-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 000-7.78z"/></svg>
              ขออนุญาต <span className="header-meta-names">พี่คิง · พี่มาลี · ทีมงานทุกท่าน</span>
            </div>
            <span className="header-meta-sep" />
            <span className="header-meta-label">ข้อมูลจาก</span>
            <a href="http://whatsek.com/" target="_blank" rel="noopener noreferrer" className="header-source-link">
              <svg viewBox="0 0 24 24" width="11" height="11" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="12" cy="12" r="10"/><path d="M2 12h20M12 2a15.3 15.3 0 010 20M12 2a15.3 15.3 0 000 20"/></svg>
              whatsek.com
              <span className="link-preview">
                <img src="/whatsek-preview.jpg" alt="whatsek.com preview" className="link-preview-img" />
              </span>
            </a>
          </div>

          <div className="header-right">
            <span className="header-tagline">ชะเอิงเอย ชะเอิงเอย ตลกจังเลย</span>
          </div>
        </div>
      </header>
      ...
      <footer className="mobile-footer">
        <div className="container mobile-footer-inner">
          ...
          <span className="header-meta-sep" />
          <div className="mobile-footer-source">
            ข้อมูลจาก
            <a href="http://whatsek.com/" target="_blank" rel="noopener noreferrer" className="header-source-link">
              <svg viewBox="0 0 24 24" width="11" height="11" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="12" cy="12" r="10"/><path d="M2 12h20M12 2a15.3 15.3 0 010 20M12 2a15.3 15.3 0 000 20"/></svg>
              whatsek.com
